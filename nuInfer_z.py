...
def callback(data):
  ...
  print "anomalyscore : {0}".format(anomalyscore)
  ...
  if inference is not None:
    ...
    actHistory.append(result.rawInput['z'])
...
if __name__=="__main__":
  model = ModelFactory.create(model_params.LIGHTON_PARAMS)
  model.enableInference({'predictedField': 'z'})
  ...
  infer_pub = rospy.Publisher('sensory_inference_stream_z', Float64, queue_size=10)
