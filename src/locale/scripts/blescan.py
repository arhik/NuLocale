  ...
  #               i =0 
        if event == LE_META_EVENT:
            ...
            if subevent == EVT_LE_CONN_COMPLETE:
                ...
                print  "The number of reports received are {0}".format(num_reports)
                report_pkt_offset = 0
                dev_mac = packed_bdaddr_to_string(pkt[report_pkt_offset + 3:report_pkt_offset + 9])
