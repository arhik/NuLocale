...
def callback(data):
  ...
  if inference is not None:
    ...
    actHistory.append(result.rawInput['d1'])
...
if __name__=="__main__":
  model = ModelFactory.create(model_params.MODEL_PARAMS)
  model.enableInference({'predictedField': 'd1'})
  ...
  infer_pub = rospy.Publisher('sensory_inference_stream_d1', Float32, queue_size=10)
