...
def callback(data):
  ...
  if inference is not None:
    ...
    actHistory.append(result.rawInput['d3'])
...
if __name__=="__main__":
  model = ModelFactory.create(model_params.MODEL_PARAMS)
  model.enableInference({'predictedField': 'd3'})
  ...
  infer_pub = rospy.Publisher('sensory_inference_stream_d3', Float32, queue_size=10)
